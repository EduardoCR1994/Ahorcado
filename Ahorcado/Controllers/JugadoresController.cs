...
namespace Ahorcado.Controllers
{
    public class JugadoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Identificacion,Nombre")] Jugador jugador)
        {
            if (ModelState.IsValid)
            {
                var existe = db.Jugador.Any(j => j.Identificacion == jugador.Identificacion);
                if (existe)
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Identificacion,Nombre")] Jugador jugador)
        {
            if (ModelState.IsValid)
            {
